...
class LlmRecord(models.Model):
    llm_record_id = models.IntegerField(primary_key=True)
...
class LlmRecordDetail(models.Model):
    detail_id = models.IntegerField(primary_key=True)
    llm_record_id = models.IntegerField(blank=True, null=True)
    io_type = models.IntegerField(blank=True, null=True)
...
class QuestionInfo(models.Model):
    ...
    question_raw = models.CharField(max_length=255, blank=True, null=True)
    checkpoints_count = models.CharField(max_length=255, blank=True, null=True)
